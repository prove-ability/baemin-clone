...
// this will be aliased by webpack at runtime (this is just for typing)
const resolved_router_1 = (0, tslib_1.__importDefault)(require("./resolved-router"));
...
const RouterDecorator = (Story, context) => {
    ...
    (0, jsx_runtime_1.jsx)(resolved_router_context_1.RouterContext.Provider, Object.assign({ value: resolved_router_1.default.router }, { children: (0, jsx_runtime_1.jsx)(Story, {}, void 0) }), void 0));
};
