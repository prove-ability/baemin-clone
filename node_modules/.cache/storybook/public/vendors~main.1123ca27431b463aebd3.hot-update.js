...
/*! exports used: style, styleVariants */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* unused harmony export assignVars */
/* unused harmony export composeStyles */
/* unused harmony export createGlobalTheme */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return styleVariants; });
...
function recipe(options, debugId) {
  ...
  var defaultClassName = typeof base === 'string' ? base : Object(_vanilla_extract_css__WEBPACK_IMPORTED_MODULE_1__[/* style */ "a"])(base, debugId); // @ts-expect-error

  var variantClassNames = mapValues(variants, (variantGroup, variantGroupName) => Object(_vanilla_extract_css__WEBPACK_IMPORTED_MODULE_1__[/* styleVariants */ "b"])(variantGroup, styleRule => typeof styleRule === 'string' ? [styleRule] : styleRule, debugId ? "".concat(debugId, "_").concat(variantGroupName) : variantGroupName));
  var compounds = [];
  ...
  for (var {
    ...
    compounds.push([_variants, typeof theStyle === 'string' ? theStyle : Object(_vanilla_extract_css__WEBPACK_IMPORTED_MODULE_1__[/* style */ "a"])(theStyle, "".concat(debugId, "_compound_").concat(compounds.length))]);
  }
...
//# sourceMappingURL=vendors~main.1123ca27431b463aebd3.hot-update.js.map